...
{
    public static class CyclicGenerationSsessionKeyTwo
    {
        public static ushort GetNextCounterValue(ushort counter)
        {
            return (ushort)(counter + 1);
        }

        public static ushort GenerateSessionKey(ushort counter, ushort masterKey)
        {
        ...
        public static ushort Encrypt(ushort masterKey, ushort value)
        {
